...
ax.plot(p_vals, damping_median, label='Learned damping', color=submodel1Color, linewidth=3)
ax.fill_between(p_vals, damping_lower, damping_upper, color=submodel1Color, alpha=0.2)
...
import tikzplotlib
tikzplotlib.save("tikz/submodel1_damping_force.tex")